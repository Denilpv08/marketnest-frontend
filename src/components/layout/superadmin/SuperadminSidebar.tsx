...
import { MdStorefront, MdDashboard, MdPeople } from "react-icons/md";
import { FiLogOut, FiUser } from "react-icons/fi";

const menuItems = [
  { href: "/superadmin/dashboard", label: "Dashboard", icon: MdDashboard },
  { href: "/superadmin/stores", label: "Establecimientos", icon: MdStorefront },
  { href: "/superadmin/users", label: "Usuarios", icon: MdPeople },
];
    ...
    <aside className="w-64 bg-gray-900 min-h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center gap-2">
          <MdStorefront className="text-purple-400 text-2xl" />
          <span className="text-white font-bold text-lg">MarketNest</span>
        </div>
        <p className="text-gray-400 text-xs mt-1">Panel superadmin</p>
      </div>
      ...
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-purple-400 text-xs">Superadmin</p>
          </div>
        </div>
      </div>
